...
public class InscripcionData {
    ...
    public List<Materia> obtenerMateriasCursadas(int id) {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String SQL = "SELECT * FROM  materia m , inscripcion i WHERE i.idMateria = m.idMateria AND i.idAlumno = ? ORDER BY m.idMateria";
    ...
    public List<Materia> obtenerMateriasNoCursadas(int id) {
        ...
        String SQL2 = " SELECT * FROM materia m WHERE m.idMateria NOT IN (SELECT i.idMateria FROM inscripcion i WHERE i.idAlumno = ? ORDER BY m.idMateria)";
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
